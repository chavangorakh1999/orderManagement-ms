    ...
    <div className="flex items-center gap-4 py-4 border-b border-gray-100 last:border-b-0">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="w-8 h-8 rounded-full border border-gray-300 text-gray-600 flex items-center justify-center hover:bg-gray-100 transition-colors cursor-pointer"
        >
          -
        </button>
      ...
      <div className="text-right shrink-0 w-20">
        <p className="font-semibold text-gray-900">{formatPrice(lineTotal)}</p>
      </div>
